...
class Goslate(object):
    ...
    def _open_url(self, url):
        ...
        request = Request(url, headers={'User-Agent':'stagefright/1.2 (Linux;Android 5.0)','Referer':'https://translate.google.com/'})
    ...
    def _basic_translate(self, text, target_language, source_language=''):
        ...
        GOOGLE_TRASLATE_URL = 'http://translate.google.com/translate_tts'
...
if __name__ == '__main__':
    try:
        _main(sys.argv)
        gs = Goslate()
        print(gs.translate('Desh Ka Pradhan Mantri kaun hai', 'hi'))
    except:
